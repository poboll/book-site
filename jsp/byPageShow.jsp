                            ...
                            <div class="productItem">
                                <div class="imgBox">
                                    <a href="showDetail.jsp" target="_blank">
                                        <img src="../image/book/book_list4/book_list4.jpg" alt=""
                                            style="height:188px;width: 188px;">
                                    </a>
                                </div>
                                <div class="infoCont">
                                    <div class="titleRow">
                                        <a class="productTitle" title="" href="showDetail.jsp"
                                            target="_blank">世界那么大，我想去看看
                                            <span class="feature"><span class="featureItem">文艺文学 </span> <span
                                                    class="featureItem"> 最畅销书籍</span></span>
                                        </a>
                                    </div>
                                    <div class="saleRow">
                                        <div class="col fl">
                                            <span class="price"><span class="priceYue">约</span> <span
                                                    class="priceSign">¥</span> <span class="priceNum">23</span> </span>
                                        </div>
                                    ...
                                    <div class="infoRow commentRow">
                                        <a class="userComment" target="_blank" href="">点评<span class="num">2111</span>
                                            条</a>
                                ...
                                <div class="infoCont">
                                    <div class="titleRow">
                                        <a class="productTitle" title="" href="" target="_blank">智能手表
                                            <span class="feature"><span class="featureItem">钻石流光镜面</span><span
                                                    class="featureItem">超薄大屏</span></span>
                                        </a>
                                    </div>
                                    <div class="saleRow">
                                        <div class="col fl">
                                            <span class="price"><span class="priceYue">约</span> <span
                                                    class="priceSign">¥</span> <span class="priceNum">2036</span>
                                            </span>
                                        </div>
                                        <div class="col end fr">
                                            <span class="weekSale">月销量<span class="num">1799</span></span>
