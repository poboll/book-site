                        ...
                        <div class="cart_content" id="cart_content">
                            ...
                            <div class="cart_content_all" style="display: none;">
                                ...
                                <div class="con_all">
                                    ...
                                    <div><span class="price_gongji">共计<em>￥</em><span
                                                class="total_price">69</span></span><a href="lookShoppingCar.jsp"
                                            class="cart_btn" rel="nofollow">去购物车结算</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="content" class="wrap clear">
                    ...
                    <div class="description clear">
                        <div class="dleftArea fl">
                            ...
                            <ul class="thumb">
                                <li class="tfirst">
                                    <a href=""><img src="../image/book/book_list4/list4_lit1.jpg" height="50" width="50"
                                            alt=""></a>
                                </li>
                                <li>
                        ...
                        <div class="drightArea fl clear">
                            <div class="itemInfo fl clear">
                                ...
                                <div id="compare">
                                    <a href="#none" id="comp_1279804" data-sku="1279804"
                                        class="J_contrast btn-compare selected btn-compare-s-active"
                                        clstag="shangpin|miaonei|product|jiaruduibi">
                                        <span>对比</span>
                                    </a>
                                </div>
                                <div id="summary">
                                    <div id="comment-count" clstag="shangpin|miaonei|product|1|pingjiabtn">
                                    ...
                                    <div id="summary-price">
                                        ...
                                        <div class="dd">
                                            ...
                                            <a data-type="1" data-sku="1279804" id="notice-downp" class="J-notify-1"
                                                href="#none" clstag="shangpin|miaonei|product|1|jiangjia">(降价通知)</a>
                                        </div>
                                    </div>
                                                ...
                                                <div class="content">
                                                    <div data-widget="tabs" class="m JD-stock" id="JD-stock">
                                                        <div class="mt">
                                                            <ul class="tab">
                                                                <li data-index="0" data-widget="tab-item" class=""><a
                                                                        href="#none" class=""><em>北京</em><i></i></a>
                                                                </li>
                                                                <li data-index="1" data-widget="tab-item" style=""
                                                                    class=""><a href="#none" class=""
                                                                        title="朝阳区"><em>朝阳区</em><i></i></a></li>
                                                                <li data-index="2" data-widget="tab-item"
                                                                    style="display: list-item;" class="curr"><a
                                                                        href="#none" class="hover"
                                                                        title="三环以内"><em>三环以内</em><i></i></a></li>
                                                                <li data-index="3" data-widget="tab-item"
                                                                    style="display: none;"><a href="#none"
                                                                        class=""><em>请选择</em><i></i></a></li>
                                                            </ul>
                                                        ...
                                                        <div class="mc" data-area="1" data-widget="tab-content"
                                                            id="stock_city_item" style="display: none;">
                                                            <ul class="area-list">
                                                        ...
                                                        <div class="mc" data-area="2" data-widget="tab-content"
                                                            id="stock_area_item" style="display: block;">
                                                            <ul class="area-list">
                                                                ...
                                                                <li class="long-area"><a href="#none"
                                                                        data-value="2819">三环到四环之间</a></li>
                                                                <li class="long-area"><a href="#none"
                                                                        data-value="2839">四环到五环之间</a></li>
                                                                <li class="long-area"><a href="#none"
                                                                        data-value="2840">五环到六环之间</a></li>
                                                            </ul>
                                                        </div>
                                                        <div class="mc" data-area="3" data-widget="tab-content"
                                                            id="stock_town_item" style="display: none;"></div>
                                                    </div><span class="clr"></span>
                                                </div>
                                                <div class="close" onclick="$('#store-selector').removeClass('hover')">
                                                </div>
                                            </div>
                                            <div id="store-prompt">
                                                <b>有货</b>，支持&nbsp;
                                                <a href="http://help.jd.com/user/issue/103-983.html" target="_blank"
                                                    title="钻石会员自营订单满59元（含）免运费， 其他会员自营订单满79元（含）免运费， 不足金额订单收取5元/单运费（偏远地区额外收取10元/件）。">79免运费</a>
                                                &nbsp;&nbsp;|&nbsp;&nbsp;
                                                <a href="http://help.jd.com/user/issue/103-983.html" target="_blank"
                                                    title="支持送货上门后再收款，支持现金、POS机刷卡等方式">货到付款</a>
                                                <span class="charges"></span>
                                            </div>
                                        </div>
                                        <span class="clr"></span>
                                    </div>
                                    <div id="summary-service" clstag="shangpin|miaonei|product|1|fuwu">
                                        <div class="dt">服　　务：</div>
                                        <div class="dd"><span class="deliver">由 时代 发货,</span>
                                            <a href="" clstag="shangpin|miaonei|product|bbtn" class="hl_red">魅族手机旗舰店</a>
                                ...
                                <dl class="amount dl clear">
                                    ...
                                    <dd>
                                        <span class="stock" id="J_Stock">
                                            <a href="#" hidefocus="" class="reduce J_Reduce iconfont disable-reduce"
                                                data-spm-anchor-id="2013.1.20140002.5">-</a>
                                            <input id="J_IptAmount" type="text" class="tb-text" value="1" maxlength="8"
                                                title="请输入购买量"><a href="#" hidefocus=""
                                                class="tb-increase J_Increase tb-iconfont"
                                                data-spm-anchor-id="2013.1.20140002.6">+</a>&nbsp;&nbsp;&nbsp; 件
                                        </span>
                                ...
                                <div id="J_juValid" class="action clear">
                                    <div class="btn-buy fl">
                                        <a href="lookShoppingCar.jsp" data-addfastbuy="true" title="点击此按钮，到下一步确认购买信息"
                                            class="J_LinkBuy" data-spm-click="gostr=/tbdetail;locaid=d1"
                                            shortcut-key="b" shortcut-label="立即购买" shortcut-effect="click"
                                            data-spm-anchor-id="2013.1.20140002.d1">立即购买</a>
                                    </div>
                                    <div class="btn-add fl">
                                        <a href="#" title="加入购物车" class="J_LinkAdd"
                                            data-spm-click="gostr=/tbdetail;locaid=d2" shortcut-key="a"
                                            shortcut-label="加入购物车" shortcut-effect="click"
                                            data-spm-anchor-id="2013.1.20140002.9"><i class="iconfont"></i>加入购物车</a>
                                    </div>
                                </div>
                                <!-- /立即购买，放入购物车 -->
                                <div class="dl">
                            ...
                            <div class="dadd fr" id="r_mod">
                                <div class="mod_change" id="r_mod_change">
                                    ...
                                    <p class="see_more">
                                        <a href="http://shop.yhd.com/m-3941.html" target="_blank"
                                            onclick="addTrackPositionToCookie(1,'detail_fpage_seemore_goshop')">去店铺逛逛
                                            <span class="iconDetail"></span>
                                        </a>
                                    </p>
                                </div>
                    ...
                    <div id="detailRight" class="fr">
                        <ul class="des_tab">
                            <li class="des_tabbox" id="detail_desc_tab">
                                ...
                                <a href="javascript:void(0)" class="tab" id="desc_sppj"
                                    tabindex="-100">评价&nbsp;<em>3</em></a>
                                <a tabindex="1" href="javascript:void(0)" class="tab">规格及包装</a>
                                <a tabindex="3" href="javascript:void(0)" class="tab">售后服务</a><a
                                    href="javascript:void(0)" id="desc_spwd" class="tab" tabindex="-101">商品问答</a>
                            </li>
                            <li class="des_act">
                                <div class="btnbox">
                                    <a class="add_cart" style="display:none;" id="detail_desc_addCartBtn"
                                        href="javascript:void(0);"><span>加入购物车</span></a>
                                </div>
                                <div style="display:none;" id="detail_desc_FaqBtn" class="onlinebox"><a
                                        href="javascript:void(0);">商家客服</a></div>
                            </li>
                        </ul>
                        ...
                        <div class="des_img">
                            ...
                            <div class="hr40"></div>
                            <div>
                                <img height="60" width="750" style="margin-top: 10.0px;"
                                    src="../image/detail/css03.jpg">
                            </div>
                            <table width="750" cellspacing="0" cellpadding="0" border="0"
                                style="line-height: 23.0px;font-size: 14.0px;color: #666666;margin-top: 10.0px;border: solid 1.0px #cccccc;border-width: 1.0px 0 0 1.0px;">
                                <tbody>
                                    <tr>
                                        <td width="119" bgcolor="#FBFBFB" align="right"
                                            style="border: solid 1.0px #cccccc;border-width: 0 1.0px 1.0px 0;">&nbsp;书名：
                                        </td>
                                        <td width="628"
                                            style="border: solid 1.0px #cccccc;border-width: 0 1.0px 1.0px 0;">
                                            &nbsp;【正版】图解CSS3：核心技术与案例实战|63768</td>
                                    </tr>
                                    <tr>
                                        <td width="119" bgcolor="#FBFBFB" align="right"
                                            style="border: solid 1.0px #cccccc;border-width: 0 1.0px 1.0px 0;">
                                            &nbsp;图书定价：</td>
                                        <td width="628"
                                            style="border: solid 1.0px #cccccc;border-width: 0 1.0px 1.0px 0;">&nbsp;79元
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="119" bgcolor="#FBFBFB" align="right"
                                            ...
                                            &nbsp;图书作者：</td>
                                        <td width="628"
                                            style="border: solid 1.0px #cccccc;border-width: 0 1.0px 1.0px 0;">&nbsp;大漠
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="119" bgcolor="#FBFBFB" align="right"
                                    ...
                                    <tr>
                                        <td width="119" bgcolor="#FBFBFB" align="right"
                                            style="border: solid 1.0px #cccccc;border-width: 0 1.0px 1.0px 0;">&nbsp;开本：
                                        </td>
                                        <td style="border: solid 1.0px #cccccc;border-width: 0 1.0px 1.0px 0;">16开</td>
                                    </tr>
                                    <tr>
                                        <td width="119" bgcolor="#FBFBFB" align="right"
                                            style="border: solid 1.0px #cccccc;border-width: 0 1.0px 1.0px 0;">&nbsp;页数：
                                        </td>
                                        <td style="border: solid 1.0px #cccccc;border-width: 0 1.0px 1.0px 0;">486</td>
                                    </tr>
                                    <tr>
                                        <td width="119" bgcolor="#FBFBFB" align="right"
                                            style="border: solid 1.0px #cccccc;border-width: 0 1.0px 1.0px 0;">&nbsp;版次：
                                        </td>
                            ...
                            <table width="750" cellspacing="0" cellpadding="0" border="0"
                                style="border: 1.0px solid #cccccc;margin-top: 10.0px;line-height: 23.0px;font-size: 14.0px;color: #666666;">
                                <tbody>
                                    <tr>
                                        <td
                                            style="border-bottom: 1.0px dashed #cccccc;background-color: #fbfbfb;font-weight: bold;color: #990000;">
                                            &nbsp;作者简介</td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 10.0px;">
                                            廖伟华(网名：大漠)，资深Web前端工程师，W3cplus(http：／／www．w3cplus．com)创始人，目前就职于Ctrip
                                            UED。中国Drupal社区核心成员之一。对HTML5、CSS3、XHTML和Sass等前端脚本语言有非常深入的认识和丰富的实践经验，尤其专注对CSS3的研究，是国内最早研究和使用CSS3技术的一批人。现在还关注Web产品策划、交互设计、SEO以及移动端开发。2012年4月刊的《程序员》杂志上发表文章“Twitter
                                            Bootstrap：前端框架利器”。</td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="padding: 10.0px;">
                                            ...
                                            <br>《图解CSS3：核心技术与案例实战》理论知识系统全面，详细讲解了选择器、边框、背景、文本、颜色、盒模型、伸缩布局盒模型、多列布局、渐变、过渡、动画、媒体、响应Web设计、Web字体等主题下涵盖的所有CSS3新特性，所有这些都巧妙地融入到案例中，而不是纯粹枯燥的理论讲解；讲解方式直观易懂，以图解的方式巧妙地展示了这些新特性；实战性强，既为每个知识点精心设计了小案例，也有综合性的大案例，所有案例都非常详尽，有功能需求分析、设计思路和完整代码，还有最终的效果展示。
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <div id="service-2014" clstag="h|miaonei|2023|32a">
                    ...
                    <div class="w wrap clear">
                        <dl class="fore1">
                            ...
                            <dd>
                                <div><a rel="nofollow" target="_blank"
                                        href="http://help.jd.com/user/issue/list-29.html">购物流程</a></div>
                                <div><a rel="nofollow" target="_blank"
                                        href="http://help.jd.com/user/issue/list-151.html">会员介绍</a></div>
                                <div><a rel="nofollow" target="_blank"
                                        href="http://help.jd.com/user/issue/list-297.html">生活旅行/团购</a></div>
                                <div><a rel="nofollow" target="_blank"
                                        href="http://help.jd.com/user/issue.html">常见问题</a></div>
                                <div><a rel="nofollow" target="_blank"
                                        href="http://help.jd.com/user/issue/list-136.html">大家电</a></div>
                                <div><a rel="nofollow" target="_blank"
                                        href="http://help.jd.com/user/index.html">联系客服</a></div>
                            </dd>
                        </dl>
                        <dl class="fore2">
                            <dt>配送方式</dt>
                            <dd>
                                <div><a rel="nofollow" target="_blank"
                                        href="http://help.jd.com/user/issue/list-81-100.html">上门自提</a></div>
                                <div><a rel="nofollow" target="_blank"
                                        href="http://help.jd.com/user/issue/list-81.html">211限时达</a></div>
                                <div><a rel="nofollow" target="_blank"
                                        href="http://help.jd.com/user/issue/103-983.html">配送服务查询</a></div>
                                <div><a rel="nofollow" target="_blank"
                                        href="http://help.jd.com/user/issue/109-188.html">配送费收取标准</a></div>
                        ...
                        <dl class="fore3">
                            ...
                            <dd>
                                <div><a rel="nofollow" target="_blank"
                                        href="http://help.jd.com/user/issue/list-172.html">货到付款</a></div>
                                <div><a rel="nofollow" target="_blank"
                                        href="http://help.jd.com/user/issue/list-173.html">在线支付</a></div>
                                <div><a rel="nofollow" target="_blank"
                                        href="http://help.jd.com/user/issue/list-176.html">分期付款</a></div>
                                <div><a rel="nofollow" target="_blank"
                                        href="http://help.jd.com/user/issue/list-174.html">邮局汇款</a></div>
                                <div><a rel="nofollow" target="_blank"
                                        href="http://help.jd.com/user/issue/list-175.html">公司转账</a></div>
                            </dd>
                        </dl>
                        <dl class="fore4">
                            <dt>售后服务</dt>
                            <dd>
                                <div><a rel="nofollow" target="_blank"
                                        href="http://help.jd.com/user/issue/321-981.html">售后政策</a></div>
                                <div><a rel="nofollow" target="_blank"
                                        href="http://help.jd.com/user/issue/list-132.html">价格保护</a></div>
                                <div><a rel="nofollow" target="_blank"
                                        href="http://help.jd.com/user/issue/130-978.html">退款说明</a></div>
                                <div><a rel="nofollow" target="_blank"
                                        href="http://myjd.jd.com/repair/repairs.action">返修/退换货</a></div>
                                <div><a rel="nofollow" target="_blank"
                                        href="http://help.jd.com/user/issue/list-50.html">取消订单</a></div>
                            </dd>
                        </dl>
                        <dl class="fore5">
                            <dt>特色服务</dt>
                            <dd>
                                ...
                                <div><a target="_blank" href="http://help.jd.com/user/issue/list-134.html">DIY装机</a>
                                </div>
                                <div><a rel="nofollow" target="_blank" href="http://fuwu.jd.com/">延保服务</a></div>
                                <div><a rel="nofollow" target="_blank"
                                        href="http://giftcard.jd.com/market/index.action">时代E卡</a></div>
                        ...
                        <div id="coverage">
                            ...
                            <div class="dd">
                                ...
                                <p class="ar"><a target="_blank"
                                        href="http://help.jd.com/user/issue/103-983.html">查看详情&nbsp;&gt;</a></p>
                            </div>
                        </div>
                        <span class="clr"></span>
                    </div>
