                ...
                <div class="content_show_wrapper">
                    ...
                    <div id="group_show">
                        <div class="content_header clear">
                            <div class="cart_timer_wrapper"> <i class="icon_small png"></i> <span
                                    class="cart_timer_counting"> 请在 <span class="cart_timer_text">14分51秒</span>
                                    内去结账，并在下单后 <span class="pink">20</span> 分钟内完成支付 </span> <span
                                    class="cart_timer_out"> 已超过购物车商品保留时间，请尽快结算。 </span> [<a
                                    class="cart_timer_tip float_box" href="javascript:void(0)"> ? <div class="pop_box">
                                        <span class="arrow_t_1"><span class="arrow_t_2"></span></span>
                                        <div class="timer_tip_text"> 由于商品库存有限，我们只能暂为您最多保存20分钟，<br>20分钟后购物车将被清空，请尽快结算订单。
                                        </div>
                                    </div> </a>] </div>
                            ...
                            <div class="common_shippment"> <i class="icon_small icon_baoyou png">包邮</i>
                                时代发货商品满2件或299元包邮,新用户首单全场满39元包邮 </div>
                        </div>
                        <div class="groups_wrapper">
                            <table class="cart_group_item  cart_group_item_product">
                                    ...
                                    <tr>
                                        <th class="cart_overview">
                                            <div class="cart_group_header">
                                                <input class="js_group_selector cart_group_selector" checked="checked"
                                                    type="checkbox">
                                                <h2>时代在线发货</h2>
                                            </div>
                                        </th>
                                ...
                                <tbody class="hide">
                                    <tr class="cart_item " hashid="d150603p892053zc" id="1057066_d150603p892053zc"
                                        product_id="892053" item_price="48.00" category_v3_3="18" brand_id="623"
                                        product_type="product">
                                        <td valign="top">
                                            <div class="cart_item_desc clear">
                                                <input class="js_item_selector cart_item_selector"
                                                    data-item-key="1057066_d150603p892053zc" checked="'checked'/"
                                                    type="checkbox">
                                                <div class="cart_item_desc_wrapper">
                                                    <a class="cart_item_pic"
                                                        href="http://sh.jumei.com/i/deal/d150603p892053zc.html"
                                                        target="_blank"> <img
                                                            src="../image/book/book_list4/list4_lit1.jpg"
                                                            alt="世界那么大，我想去看看！"> <span class="sold_out_pic png"></span>
                                                    </a> <a class="cart_item_link" title="世界那么大，我想去看看"
                                                        href="http://sh.jumei.com/i/deal/d150603p892053zc.html"
                                                        target="_blank">世界那么大，我想去看看！</a>
                                                    <p class="sku_info">规格：<span
                                                            class="cart_item_attribute">彩色</span>&nbsp; </p>
                                                    <div class="sale_info clear">
                                                        <div class="tips_pop_full float_box JS_tips_pop_full">
                                                            <div> <a class="sale_tag gift JS_sale_tag"
                                                                    data-promo-type="gift"> 满赠 <i
                                                                        class="icon_small png"></i> </a> </div>
                                                            <div class="pop_box JS_pop_box">
                                                                <div><span class="arrow_t_1"><span
                                                                            class="arrow_t_2"></span></span>
                                                                </div>
                                                                <div>
                                                                    <a class="clear promo_sale_item promo_has_url"
                                                                        target="_blank"
                                                                        href="http://hd.jumei.com/act/4-3-6035-ppt_maybelline_150603.html">
                                                                        <span class="title">时代图书团满99送109</span> <span
                                                                            class="tips">查看活动</span> </a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="tips_pop_full float_box JS_tips_pop_full">
                                                            <div> <a class="sale_tag reduce JS_sale_tag"
                                                                    data-promo-type="reduce"> 满减 <i
                                                                        class="icon_small png"></i> </a> </div>
                                                            <div class="pop_box JS_pop_box">
                                                                <div><span class="arrow_t_1"><span
                                                                            class="arrow_t_2"></span></span>
                                                                ...
                                                                <div>
                                                                    <a class="clear promo_sale_item promo_has_url"
                                                                        target="_blank"
                                                                        href="http://hd.jumei.com/act/4-3-6035-ppt_maybelline_150603.html">
                                                                        <span class="title">时代图书团满99减20</span> <span
                                                                            class="tips">查看活动</span> </a>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <td>
                                            <div class="cart_item_num ">
                                                <div class="item_quantity_editer clear"
                                                    data-item-key="1057066_d150603p892053zc"> <span
                                                        class="decrease_one disabled ">-</span>
                                                    <input class="item_quantity" value="1" type="text"> <span
                                                        class="increase_one ">+</span>
                                                </div>
                                        ...
                                        <td>
                                            <div class="cart_item_option">
                                                <a class="icon_small delete_item png"
                                                    data-item-key="1057066_d150603p892053zc" href="javascript:void(0)"
                                                    title="删除"></a>
                                            </div>
                                ...
                                <tbody class="hide2">
                                    <tr class="cart_item " hashid="d150603p892053zc" id="1057066_d150603p892053zc"
                                        product_id="892053" item_price="32.00" category_v3_3="18" brand_id="623"
                                        product_type="product">
                                        <td valign="top">
                                            <div class="cart_item_desc clear">
                                                <input class="js_item_selector cart_item_selector"
                                                ...
                                                <div class="cart_item_desc_wrapper">
                                                    <a class="cart_item_pic"
                                                        href="http://sh.jumei.com/i/deal/d150603p892053zc.html"
                                                        target="_blank"> <img
                                                            src="../image/book/book_list2/list2_lit1.jpg" alt="傲慢与偏见">
                                                        <span class="sold_out_pic png"></span> </a> <a
                                                        class="cart_item_link" title="傲慢与偏见"
                                                        href="http://sh.jumei.com/i/deal/d150603p892053zc.html"
                                                        target="_blank">傲慢与偏见（精包装）</a>
                                                    <p class="sku_info"> 规格：<span
                                                            class="cart_item_attribute">彩色</span>&nbsp; </p>
                                                    <div class="sale_info clear">
                                                        <div class="tips_pop_full float_box JS_tips_pop_full">
                                ...
                                <tbody>
                                    <tr class="cart_item " hashid="d150603p892053zc" id="1057066_d150603p892053zc"
                                        product_id="892053" item_price="34.00" category_v3_3="18" brand_id="623"
                                        product_type="product">
                                        <td valign="top">
                                            <div class="cart_item_desc clear">
                                                <input class="js_item_selector cart_item_selector"
                                                ...
                                                <div class="cart_item_desc_wrapper">
                                                    <a class="cart_item_pic"
                                                        href="http://sh.jumei.com/i/deal/d150603p892053zc.html"
                                                        target="_blank"> <img
                                                            src="../image/book/book_list1/list1_lit1.jpg" alt="平凡的世界">
                                                        <span class="sold_out_pic png"></span> </a> <a
                                                        class="cart_item_link" title="平凡的世界"
                                                        href="http://sh.jumei.com/i/deal/d150603p892053zc.html"
                                                        target="_blank">平凡的世界</a>
                                                    <p class="sku_info"> 规格：<span
                                                            class="cart_item_attribute">彩色</span>&nbsp; </p>
                                                    <div class="sale_info clear">
                                                        <div class="tips_pop_full float_box JS_tips_pop_full">
                                            ...
                                            <div class="cart_item_desc clear">
                                                ...
                                                <div class="cart_item_desc_wrapper">
                                                    <a class="cart_item_pic"
                                                        href="http://sh.jumei.com/i/deal/d150603p892053zc.html"
                                                        target="_blank"> <img
                                                            src="../image/book/book_list7/list7_lit1.jpg"
                                                            alt="有一个地方我们知道"> <span class="sold_out_pic png"></span> </a>
                                                    <a class="cart_item_link" title="有一个地方我们知道"
                                                        href="http://sh.jumei.com/i/deal/d150603p892053zc.html"
                                                        target="_blank">有一个地方我们知道</a>
                                                    <p class="sku_info"> 规格：<span
                                                            class="cart_item_attribute">彩色</span>&nbsp; </p>
                                                    <div class="sale_info clear">
                                                        <div class="tips_pop_full float_box JS_tips_pop_full">
                        ...
                        <div class="common_handler">
                            <div class="right_handler"> 共 <span class="total_amount"> 1 </span> &nbsp;件商品 &nbsp;&nbsp;
                                商品应付总额：<span class="total_price">￥141.00</span> <a id="go_to_order" class="btn"
                                    href="lookOrderForm.jsp">去结算</a> </div>
                            ...
                            </label> <a class="go_back_shopping"
                                href="http://sh.jumei.com/i/deal/d150603p892053zc.html">继续购物</a> <span
